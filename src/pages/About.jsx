...
const About = () => {
  return (
    <section className="min-h-screen px-6 md:px-20 py-20 bg-white dark:bg-zinc-900 text-black dark:text-white">
      <div className="max-w-6xl mx-auto space-y-64 flex-col flex">
        {/* About Me */}
        <motion.div
          className="relative text-left w-1/2 self-start"
        ...
        >
          ...
          >
            <span className="relative inline-block px-4 py-2 mb-10 before:absolute before:bottom-0 before:left-1/2 before:-translate-x-1/2 before:w-2/3 before:h-1 before:bg-red-500 before:rounded">
              About Me
            </span>
          </motion.h1>
          ...
          <p className="text-lg leading-relaxed text-zinc-700 dark:text-zinc-300">
            ...
            Bachelor of Technology in Computer Science. With a passion for clean
            UI and thoughtful user experiences, I specialize in building modern,
          ...
          <motion.img
            ...
            className="absolute -right-110 top-25 w-80 hidden md:block opacity-90"
          />
        </motion.div>

        {/* My Philosophy */}
        <motion.div
          className="relative text-left w-1/2 self-end"
          variants={sectionVariants}
          initial="hidden"
          whileInView="visible"
          transition={{ duration: 0.5 }}
        ...
        >
          ...
          <motion.img
            ...
            className="absolute -left-100 top-0 w-56 hidden md:block opacity-90"
          />
        </motion.div>
        ...
        >
          ...
          <motion.img
            ...
            className="absolute -right-120 top-0 w-96 hidden md:block"
          />
        </motion.div>
        ...
        >
          ...
          <ul className="list-disc pl-6 text-zinc-700 dark:text-zinc-300 space-y-1 inline-block text-left text-lg">
          ...
          <motion.img
            ...
            alt="Values Graphic"
            className="absolute -left-110 top-0 w-80 hidden md:block opacity-80"
          />
        </motion.div>
        ...
        >
          ...
          <motion.img
            ...
            className="absolute -right-90 top-0 w-72 hidden md:block opacity-90"
          />
        </motion.div>

        {/* Inspired + Beyond */}
        <motion.div
          className="text-center w-full md:w-4/5 self-center mb-40"
          variants={sectionVariants}
          initial="hidden"
          whileInView="visible"
          transition={{ duration: 0.5 }}
        ...
        >
          ...
          <div className="relative rounded-2xl bg-white/70 dark:bg-zinc-800/70 backdrop-blur-md p-8 shadow-lg shadow-zinc-500/30 dark:shadow-black/50 transition-all duration-300">
            ...
            <p className="text-lg text-zinc-700 dark:text-zinc-300 leading-relaxed">
              ...
              passions — from sketching illustrations to clearing my mind with a
              game of chess. I'm a regular at the volleyball court and the gym,
              where discipline and focus fuel both my fitness and mindset. I
              also watch anime not just for entertainment, but as a source of
              visual storytelling and creative inspiration.
            </p>
