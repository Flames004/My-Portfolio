...
const About = () => {
  return (
    <div className="min-h-screen pt-28 px-6 md:px-20 py-20 bg-transparent text-black dark:text-white">
      <div className="max-w-6xl mx-auto space-y-32 flex-col flex">
        ...
        <div className="relative flex flex-col md:flex-row items-start gap-10">
          <div className="md:w-3/5">
            <h1 className="relative font-extrabold text-5xl sm:text-6xl md:text-7xl leading-tight font-mono mb-10 text-zinc-900 dark:text-white">
        ...
        {/* My Philosophy */}
        <div className="relative flex flex-col md:flex-row-reverse items-start gap-10">
          <div className="md:w-3/5">
        ...
        {/* Inspired + Beyond */}
        <div className="text-center w-full md:w-4/5 self-center mb-32">
