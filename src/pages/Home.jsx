...
const Home = () => {
  ...
  I'm <span className="underline decoration-wavy decoration-red-500">Deepak</span>,<br />
  but the dev world knows me as <span className="text-red-600 dark:text-red-400">Flames.</span>
</h1>
<p className="mt-4 text-lg md:text-xl text-zinc-700 dark:text-zinc-300">
  A frontend developer on a quest to blend elegant UI with the energy of shonen anime. 
  I craft responsive, high-impact interfaces that punch above their weight — pixel by pixel.
</p>
<div className="mt-6">
  <a
    href="/#projects"
